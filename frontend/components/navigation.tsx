        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8 ml-12">
              <Link
                href={ROUTES.TRADE}
                className="theme-text font-medium uppercase tracking-wide transition-colors"
              >
                TRADE
              </Link>
              <Link
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              {account ? (
                ...
                >
                  ...
                  <span className="mono text-sm theme-text">
                    {prettyAddress(account.decodedAddress)}
                  </span>
                </Button>
              ) : (
          ...
          {isMenuOpen && (
            ...
            >
              <div className="flex flex-col space-y-4">
                <Link
                  href={ROUTES.TRADE}
                  className="theme-text font-medium uppercase tracking-wide"
                >
                  TRADE
                </Link>
                <Link
